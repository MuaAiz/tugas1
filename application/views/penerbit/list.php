                      ...
                      <td>
                        <center>
                          <div class="tooltip-demo">
                            ...
                            <a href="<?php echo site_url('penerbit/hapus/' . $row->idpenerbit); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?= $row->idpenerbit; ?> ?');" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Hapus Data"><i class="fa fa-trash"></i></a>
                          </div>
                        </center>
                      </td>
                    </tr>
              ...
              <form action="<?php echo site_url('penerbit/tambah'); ?>" method="post">
                <div class="modal-content">
                  <div class="modal-header bg-primary">
                    <h6 class="modal-title">Tambah Penerbit Buku</h6>
